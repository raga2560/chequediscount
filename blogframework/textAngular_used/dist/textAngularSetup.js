...
.factory('taToolFunctions', ['$window','taTranslations', function($window, taTranslations) {
	return {
		imgOnSelectAction: function(event, $element, editorScope){
			...
			var thumbnailButton = angular.element('<button type="button" class="btn btn-default btn-sm btn-small" unselectable="on" tabindex="-1">Thumb</button>');
			thumbnailButton.on('click', function(event){
				event.preventDefault();
				$element.css({
					width: '100px',
					height: '75px'
			...
			buttonGroup.append(quartButton);
			 ...
			 buttonGroup.append(thumbnailButton);
			container.append(buttonGroup);

			buttonGroup = angular.element('<div class="btn-group" style="padding-right: 6px;">');
			var floatLeft = angular.element('<button type="button" class="btn btn-default btn-sm btn-small" unselectable="on" tabindex="-1"><i class="fa fa-align-left"></i>aligh-l</button>');
